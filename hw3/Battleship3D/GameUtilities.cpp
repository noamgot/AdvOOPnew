...
namespace GameUtilities
{
	...
	void GameUtilities::changeAttacker(int& attackerNum, int& defenderNum)
	{
	...
	bool GameUtilities::registerHit(PlayerAttributes& playerAttributes, pair<int, int> coords, eShipType shipType, AttackResult& res)
	{
		auto i = 0;
	...
	*/
	...
	void GameUtilities::handleMove(const MyBoardData& board, Coordinate& move, int &attackerNum, int &defenderNum, unique_ptr<IBattleshipGameAlgo>& A,
	...
	void GameUtilities::handleMiss(Coordinate& move, unique_ptr<IBattleshipGameAlgo>& A, unique_ptr<IBattleshipGameAlgo>& B, int& attackerNum)
	{
	...
	void GameUtilities::handleHitOrSink(Coordinate& move, bool& validAttack, unique_ptr<IBattleshipGameAlgo>& A, unique_ptr<IBattleshipGameAlgo>& B,
